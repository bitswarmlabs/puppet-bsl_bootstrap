...
class bsl_bootstrap::foreman::config(
  ...
  $init_early_svc          = $bsl_bootstrap::foreman::params::init_early_svc,
  $init_early_service      = $bsl_bootstrap::foreman::params::init_early_service,
  $init_early_service_tmpl = $bsl_bootstrap::foreman::params::init_early_service_tmpl,
  $init_early_config       = $bsl_bootstrap::foreman::params::init_early_config,
  $init_early_config_tmpl  = $bsl_bootstrap::foreman::params::init_early_config_tmpl,

  $init_final_svc          = $bsl_bootstrap::foreman::params::init_final_svc,
  $init_final_service      = $bsl_bootstrap::foreman::params::init_final_service,
